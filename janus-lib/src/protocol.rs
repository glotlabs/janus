...
pub const HEADER_SIGNATURE: &str = "x-janus-signature";
pub const HEADER_SIGNATURE_KEY_ID: &str = "x-janus-key-id";
pub const HEADER_SIGNATURE_TIMESTAMP: &str = "x-janus-timestamp";
pub const HEADER_SIGNATURE_NONCE: &str = "x-janus-nonce";
pub const HEADER_SIGNATURE_CONTENT_SHA256: &str = "x-janus-content-sha256";
