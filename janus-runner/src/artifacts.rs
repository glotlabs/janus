...
use janus_lib::{ArtifactUploadResponse, HEADER_SHA256};
...
mod tests {
    ...
    use janus_lib::{ArtifactUploadResponse, HEADER_SHA256, RunnerRoute, RunnerRouteTemplate};
    use sha2::{Digest, Sha256};
        ...
        let upload = app
            ...
            .oneshot(
                Request::post(RunnerRoute::Artifacts.path())
                    .header("x-janus-key-id", "artifacts-write")
